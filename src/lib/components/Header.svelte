<header class="fixed inset-x-0 top-0 z-10 py-4 text-sm md:text-md md:py-6 backdrop-blur-sm">
	<div class="container mx-auto flex items-center justify-center gap-4 md:justify-between">
		<a class="font-serif text-lg md:text-3xl text-red-500 [-webkit-text-stroke:1px_var(--color-red-500)]" href="/">SRS.</a>
